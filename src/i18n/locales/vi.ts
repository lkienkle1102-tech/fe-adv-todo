...
const vi: typeof en = {
  ...
  profile: {
    ...
    details: {
      ...
      description: "Cập nhật tên hiển thị và địa chỉ email dùng cho tài khoản.",
      username: "Tên hiển thị",
      email: "Địa chỉ email",
      save: "Lưu thay đổi",
      saving: "Đang lưu...",
      success: "Đã cập nhật hồ sơ.",
      saved: "Thông tin mới nhất đã được lưu.",
    },
    security: {
      title: "Bảo mật",
      description: "Đổi mật khẩu để giữ an toàn cho workspace của bạn.",
      currentPassword: "Mật khẩu hiện tại",
      currentRequired: "Vui lòng nhập mật khẩu hiện tại.",
      currentIncorrect: "Mật khẩu hiện tại không chính xác.",
      newPassword: "Mật khẩu mới",
      confirmPassword: "Nhập lại mật khẩu mới",
      hint: "Dùng ít nhất 8 ký tự và tránh sử dụng lại mật khẩu ở nơi khác.",
